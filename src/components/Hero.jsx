...
const Hero = () => {
	return (
		<div>
			...
			<div className="bg-black h-[30vh] w-full relative md:h-[40vh] xl:h-[60vh]">
				<img
				...
				<div className="backdrop-brightness-75 w-full h-full grid place-items-center">
					<div className="absolute top-[35%] flex flex-col w-4/5 place-items-center text-center">
						...
						<h1 className="text-2xl text-white font-semibold drop-shadow-md md:text-5xl xl:text-8xl">
							KAMEcho Solutions!
						</h1>
					</div>
				</div>
